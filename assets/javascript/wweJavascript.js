...
function resetCharacters() {
  ...
  return {
    "John-Cena": {
      ...
      health: 120,
      attack: 8,
      imageUrl: "assets/images/john-cena.jpg",
      enemyAttackBack: 15
    },
    Undertaker: {
      name: "Edge",
      health: 100,
      attack: 14,
      imageUrl: "assets/images/edge.jpg",
      enemyAttackBack: 5
    },
    Edge: {
      name: "Kane",
      health: 150,
      attack: 8,
      imageUrl: "assets/images/kane.jpg",
      enemyAttackBack: 20
    },
    Kane: {
      name: "Undertaker",
...
function attack(numAttacks) {
  ...
  gameState.selectedDefender.health -=
    gameState.selectedCharacter.attack * numAttacks;
}
...
function defend() {
  ...
  gameState.selectedCharacter.health -=
    gameState.selectedDefender.enemyAttackBack;
}
...
$(document).ready(function() {
  ...
  */
  ...
  $("#attack-button").on("click.attack", function() {
    ...
    $("#selected-character .character-health").text(
      gameState.selectedCharacter.health
    );
